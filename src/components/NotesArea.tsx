    ...
    <div className={`bg-white rounded-lg shadow-md border border-gray-200 ${className}`}>
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-1 text-sm bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white rounded transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
      ...
      <div className="p-4">
        <textarea
          ...
          className="w-full h-64 p-3 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
